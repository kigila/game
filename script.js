    ...
    class Game {
        ...
        render(context, deltaTime){
            if (this.timer > this.interval){
                ...
                this.gameObjects.sort((element_a, element_b) => {
                    return element_a.collisionY - element_b.collisionY;
                });                  
